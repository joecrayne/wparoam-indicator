...
// Grabbed from caffein extension, substituted caffein for wparoam.
...
function getSettings(extension) {
    let schemaName = 'org.gnome.shell.extensions.wparoam';
...
function initTranslations(extension) {
    ...
    if (GLib.file_test(localeDir, GLib.FileTest.EXISTS)) {
        Gettext.bindtextdomain('gnome-shell-extension-wparoam', localeDir);
    }
    // Extension installed system-wide
    else {
        Gettext.bindtextdomain('gnome-shell-extension-wparoam', Config.LOCALEDIR);
    }
}
